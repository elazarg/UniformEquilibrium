...
problems*, Mathematics of Operations Research **45**(2), 434–454 (2020);
...
def record : Literature.PaperRecord where
  ...
  claims :=
    [ { claimId := "solo_exit_normalization_without_loss_of_generality"
        ...
        status := .provedInLean
          "Literature.SolanAndSolan2020.isεAsymptoticNash_soloNormalized_iff"
      ...
      { claimId := "alpha_player_recursion_is_decreasing"
        ...
        status := .provedInLean
          "Literature.SolanAndSolan2020.alphaLayer_antitone"
      ...
      { claimId := "alpha_solo_exit_pays_beta_players_positively"
        ...
        status := .provedInLean
          "Literature.SolanAndSolan2020.betaPlayer_alphaSoloExit_pos"
      ...
      { claimId := "draft_recursion_display_omits_distinctness"
        ...
        status := .provedInLean
          "Literature.SolanAndSolan2020.draftRecursionCore_eq_univ"
...
exists_stationaryUniformEquilibriumPayoff_of_allPlayersAbnormal" },
      { claimId := "alpha_homogeneous_lcp_gives_uniform_equilibrium_payoff"
        ...
        status := .provedInLean
          "Literature.SolanAndSolan2020.exists_uniformEquilibriumPayoff_of_alphaHomogeneous"
          "GameTheory.QuittingLCPClassification.\
