...
import MathUE.Topology.BoxComplementaritySpernerApproximation
...
This selected count depends on the mesh parameter. Subdivision transport,
homotopy invariance, and stabilization are developed in the subsequent
signed-count layers.
-/
