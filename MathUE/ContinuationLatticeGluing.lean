...
namespace Math.ContinuationLatticeGluing
...
theorem exists_common_of_nonempty_of_downwardClosed
  ...
  | inr hindex =>
      ...
      exact Finset.inf'_le witness (Finset.mem_univ i)
...
end Math.ContinuationLatticeGluing
