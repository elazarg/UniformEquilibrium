...
`MathUE.DirectedGraph` supplies directed multigraphs and their finite-walk
calculus.  This file adds integer-lattice charges, infinite walks,
bounded discrepancy, zero-charge lassos, and connected circulation
certificates.  Integer charges are the denominator-cleared form of finite
rational charge data.
...
variable {G} {start finish middle finish' : V}
