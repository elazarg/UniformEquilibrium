...
| [Q190](Q190_SINGLETON_TOGGLE_CHRONOLOGY.md) | Singleton toggle chronology | Connect static strict coalition toggles to a reached, state-matched near-minimum chronology. | [`TerminalSemanticOwnStrategyTransport`](../../UniformEquilibrium/Diagnostics/Quitting/TerminalSemanticOwnStrategyTransport.lean); [`SurvivalWeightedReachedHistoryAccount`](../../MathUE/Probability/SurvivalWeightedReachedHistoryAccount.lean). |
| [Q191](Q191_SINGLETON_TIGHT_MINIMUM_FACE.md) | Singleton-tight minimum face | Test whether the singleton-tight minimum face is invariant under a fixed one-player row. | [`TerminalSemanticSingletonTightMinimumFaceIteration`](../../UniformEquilibrium/Diagnostics/Quitting/TerminalSemanticSingletonTightMinimumFaceIteration.lean). |
