...
The detailed quitting proof search is tracked as a mechanically checkable open-leaf ledger. The general and all-quitting conjectures remain open independently of any one certificate grammar.
