...
persistent-two-label selection. It answers the unconditional selector
negatively; it does not exclude a selector restricted to an unresolved
positive-minimum or no-uniform-equilibrium branch.
-/
