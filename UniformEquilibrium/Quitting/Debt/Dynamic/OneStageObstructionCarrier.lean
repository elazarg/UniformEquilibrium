...
/-!
# Compact one-stage raw-obstruction carrier
...
finite-dimensional set of two-grade raw obstructions. Every finite co-state
pairing attains a support value whenever the carrier is nonempty.
