...
This module formalizes the support reduction for a quitting game in which
...
The resulting active-set polynomial, deviation, schedule, and Bellman
interfaces expose the exact interaction degree independently of the ambient
number of players.
-/
...
/-! ## Cubic truncation and the four-of-five case -/
...
/-- In the five-player four-active case, the unique `missing` player is
inactive. -/
...
/-! ## The general `K/N` degree theorem -/
...
/-! ## Scaled hazards and the exact collision hierarchy -/
...
/-! ## Time-varying `K/N` schedules and Bellman paths -/
...
/-! ## Unilateral deviations cost one extra active coordinate -/
...
/-! ## The genuine restricted-action collapse -/
...
/-! ## Direct existence reduction and the phantom obstruction -/
...
sufficient for a uniform-equilibrium payoff. All local Bellman and
