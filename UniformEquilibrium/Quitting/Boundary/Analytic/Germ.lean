...
* General analytic germ existence chooses an endpoint. The separate theorem
  ...
  retains a supplied complete assignment when it lies in the closure of
  positive-discount polynomial Bellman solutions. The quitting-specific
  `Bellman/Discounted/ClusterCompletion.lean` constructs the assignment and
  closure witness from a supplied hazard cluster of actual fixed points.
