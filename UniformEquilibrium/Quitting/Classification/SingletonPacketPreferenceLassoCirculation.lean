...
/-!
# Preference-lasso obstruction to packet-mass circulation
...
pinned by the *mixture* itself. A strict supported-preference lasso witnesses
the opposite at its entrance: the packet target, which is the owner's
singleton payoff, is strictly below the singleton mixture.
