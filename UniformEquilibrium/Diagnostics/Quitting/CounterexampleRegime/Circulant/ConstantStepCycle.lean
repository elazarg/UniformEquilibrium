...
/-!
# Constant-step cyclic equilibria, against the counterexample regime
...
reference to `QuittingCounterexampleRegime`.  This module reads it against the
regime, through `isEmpty_counterexampleRegime_of_soloPeriodicBlock`.

## Main results

* `isEmpty_counterexampleRegime_constantStep`
-/
