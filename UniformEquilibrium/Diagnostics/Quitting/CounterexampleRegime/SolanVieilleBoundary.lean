...
/-!
# The Solan–Vieille boundary table is in no terminal exploitability witness
...
equilibrium it consumes, because `QuittingTerminalExploitabilityWitness` is a
...
/-- **The Solan–Vieille boundary table lies in no terminal exploitability witness.** -/
theorem boundaryReward_isEmpty_terminalExploitabilityWitness :
    IsEmpty (QuittingTerminalExploitabilityWitness boundaryReward) :=
  isEmpty_quittingTerminalExploitabilityWitness_of_exists_uniformEquilibriumPayoff
