...
theorem endpointDifference_zero_eq_expanded
    (h : Player → ℝ) (h0 : ∀ who, 0 ≤ h who)
    (h1 : ∀ who, h who ≤ 1) (tail : Payoff Player) :
    quittingRootEndpointDifference reward tail (rootOfHazard h h0 h1) 0 =
      BlockPairCharts.expandedDifference h tail 0 := by
