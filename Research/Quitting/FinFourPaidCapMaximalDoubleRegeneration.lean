...
theorem nonempty_maximalOneStepPaidResetRegeneration_of_quantitativeDebtDescent
  ...
  · have inert := source.inertStall_of_uniqueAllContinueAtCap port unique
    exfalso
    have hpos := descent.displacement_pos
    rw [inert.capDisplacement_eq_zero] at hpos
...
theorem repairedOwner_debt_eq_zero
  ...
  unfold quittingTerminalSemanticDebt quittingSingletonBaseRepairedProfile
...
theorem sourceMaximalRegeneration_or_repairedMaximalRegeneration_or_doubleUnique
  ...
  rcases QuittingPaidCapLiftedSource.maximalOneStepPaidResetRegeneration_or_uniqueAllContinue
        double.chain.sourceCapLiftedSource
  ...
  rcases QuittingPaidCapLiftedSource.maximalOneStepPaidResetRegeneration_or_uniqueAllContinue
        double.chain.repairedCapLiftedSource
